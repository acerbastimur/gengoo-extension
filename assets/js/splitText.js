...
!(function(e) {
  ...
  var t = e.GreenSockGlobals || e,
    ...
    d = function(e, t, i, n) {
      ...
      return (
        (i = i || l(e, null))
          ? ((e = i.getPropertyValue(t.replace(o, "-$1").toLowerCase())),
            (s = e || i.length ? e : i[t]))
          : e.currentStyle && ((i = e.currentStyle), (s = i[t])),
        n ? s : parseInt(s, 10) || 0
      );
    },
    p = function(e) {
    ...
    T = (n.SplitText = t.SplitText = function(e, t) {
      if (("string" == typeof e && (e = T.selector(e)), !e))
        throw "cannot split a null element.";
      (this.elements = p(e) ? a(e) : [e]),
        (this.chars = []),
        (this.words = []),
        (this.lines = []),
        (this._originals = []),
    ...
    B = function(e) {
      ...
      for (t = 0; s > t; t++)
        (i = n[t]),
          i._isSplit
            ? B(i)
            : (t && 3 === i.previousSibling.nodeType
    ...
    V = function(e, t, i, n, s, o, p) {
            ...
            (g || F || (D && !z)) &&
              ...
              q &&
                (((f._isSplit && g) ||
                  ...
                  (y.push(f), (f._x -= C), L(f, e, M) && (f._wordEnd = !0)),
                "BR" === f.nodeName &&
              ...
              !z && D
                ? f._isSplit
                  ...
                  ? ((f._parent = f.parentNode),
                    ...
                    u--)
                  : g ||
                    ((_ = !f.nextSibling && L(f.parentNode, e, M)),
                    f.parentNode._parent && f.parentNode._parent.appendChild(f),
                    _ && f.parentNode.appendChild(r.createTextNode(" ")),
                ...
                : D &&
                  !f._isSplit &&
                  (t.span && (f.style.display = "inline"), O.push(f)))
            : q || F
      ...
      if (q) {
        for (
          F &&
            ...
            e.appendChild(v),
            (b = v.offsetWidth + "px"),
            (_ = v.offsetParent === e ? 0 : e.offsetLeft),
            e.removeChild(v)),
            S = e.style.cssText,
        ...
        for (x = " " === M && (!F || (!z && !D)), a = 0; a < q.length; a++) {
          for (
            ...
            "BR" !== y[h].nodeName &&
              ((f = y[h]),
              v.appendChild(f),
              x && f._wordEnd && v.appendChild(r.createTextNode(" ")),
              F &&
                (0 === h &&
                  ((v.style.top = f._y + "px"), (v.style.left = C + _ + "px")),
                (f.style.top = "0px"),
                _ && (f.style.left = f._x - _ + "px")));
          0 === u
            ? (v.innerHTML = "&nbsp;")
            : z || D || (B(v), N(v, String.fromCharCode(160), " ")),
            F && ((v.style.width = b), (v.style.height = f._h + "px")),
            e.appendChild(v);
        }
        e.style.cssText = S;
      }
      F &&
        (p > e.clientHeight &&
          ((e.style.height = p - W + "px"),
          e.clientHeight < p && (e.style.height = p + A + "px")),
        o > e.clientWidth &&
          ((e.style.width = o - H + "px"),
    ...
    W = function(e, t, i, n) {
      ...
      for (
        k.insertBefore(E, e),
          ...
          l = s(e),
          _ = -1 !== l.indexOf("<"),
          t.reduceWhiteSpace !== !1 && (l = l.replace(u, " ").replace(h, "")),
          _ && (l = l.split("<").join("{{LT}}")),
          a = l.length,
          o = (" " === l.charAt(0) ? V : "") + i(),
          d = 0;
        ...
        if (((g = l.charAt(d)), g === B && l.charAt(d - 1) !== B && d)) {
          ...
          d === a - 1
            ? (o += V)
            : ")" !== l.charAt(d + 1) && ((o += V + i()), (H = !0));
        } else
          "{" === g && "{{LT}}" === l.substr(d, 6)
            ? ((o += A ? n() + "{{LT}}</" + T + ">" : "{{LT}}"), (d += 5))
            : (g.charCodeAt(0) >= f && g.charCodeAt(0) <= c) ||
              (l.charCodeAt(d + 1) >= 65024 && l.charCodeAt(d + 1) <= 65039)
            ? ((m = b(l.substr(d, 2))),
              (C = b(l.substr(d + 2, 2))),
              (p =
                (y > m || m > x || y > C || C > x) && (S > C || C > v) ? 2 : 4),
              (o +=
                A && " " !== g
                  ? n() + l.substr(d, p) + "</" + T + ">"
                  : l.substr(d, p)),
    ...
    H = function(e, t, i, n) {
      ...
      if (3 !== e.nodeType || o > 1) {
        for (t.absolute = !1, s = 0; o > s; s++)
          (r = l[s]),
            (3 !== r.nodeType || /\S+/.test(r.nodeValue)) &&
              (p &&
                3 !== r.nodeType &&
                "inline" === d(r, "display", null, !0) &&
  ...
  (E.split = function(e) {
    ...
    for (; --s > -1; )
      (n = this.elements[s]),
        ...
        (i = n.clientWidth),
        H(n, e, l, o),
        V(n, e, this.chars, this.words, this.lines, i, t);
    return (
      this.chars.reverse(),
      this.words.reverse(),
      this.lines.reverse(),
